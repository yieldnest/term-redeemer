...
contract DepositMockYnRWAxIntoTermRedeemer is BaseTestScript {
    function run() external {
        ...
        address vault = _loadAddress(Constants.TERM_NAMESPACE, Constants.TERM_VAULT_KEY);
        address depositToken = _loadAddress(Constants.MOCK_YNRWAX_NAMESPACE, Constants.MOCK_YNRWAX_KEY);
